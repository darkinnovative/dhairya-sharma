...
export default Projects;
  ...
  return (
    <section id="projects" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-black via-gray-900 to-slate-900 relative">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center text-white mb-8 sm:mb-12 md:mb-16 relative font-mono">
            <span className="text-cyan-400">&lt;</span>Projects<span className="text-cyan-400">/&gt;</span>
            <div className="absolute bottom-[-8px] sm:bottom-[-12px] left-1/2 transform -translate-x-1/2 w-12 sm:w-16 h-0.5 sm:h-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full"></div>
          </h2>
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            {projects.map((project, index) => (
              <motion.div
                key={project.id}
                className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl rounded-xl shadow-2xl shadow-cyan-500/10 overflow-hidden hover:shadow-cyan-500/20 transition-all duration-300 border border-cyan-500/20 hover:border-cyan-400/40"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                whileHover={{ y: -10 }}
              >
                <div className="relative h-64 bg-gradient-to-br from-cyan-600 via-blue-600 to-purple-700 flex items-center justify-center overflow-hidden group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-4">
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 bg-gray-900/90 backdrop-blur rounded-full flex items-center justify-center text-cyan-400 hover:bg-cyan-500 hover:text-white transition-colors duration-200 border border-cyan-500/30"
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-1 bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 rounded-full text-sm font-medium font-mono"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center space-x-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-mono"
                    >
                      <FaGithub />
                      <span>Code</span>
                    </a>
